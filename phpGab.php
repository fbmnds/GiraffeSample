 ...
 * @since PHP 5
 **/
function Gab_cURL ($_GabURL, $_GabMethod = 'GET', $_GabData = NULL, $_GabHeader = NULL, $Stop = NULL) {
...
//		
//	if (is_null($Stop)) {
//			$_X = Gab_cURL ('http://192.168.0.39', $_GabMethod, $_GabData, $_GabHeader, 'stop');
//			echo '<------------- response ------------->'."\n";
//			echo "\n".print_r (is_array ($_X) ? http_build_query ($_X) : $_X, TRUE)."\n";
//			echo '<------------- response ------------->'."\n";
//	}
...
//echo http_build_query($_result);

echo Gab_TokenGet (urldecode($_GET['username']), urldecode($_GET['password']));
